                                                                        ...
                                                                        for (let i = 0; i < ability_type.length; i++) {
                                                                            ...
                                                                            switch (ability_type[i]) {
                                                                                case 'choose':
                                                                                    ...
                                                                                    break
                                                                                case 'str':
                                                                                    ability_type_string = '力量 +'+ability_item
                                                                                    break
                                                                                case 'dex':
                                                                                    ability_type_string = '敏捷 +'+ability_item
                                                                                    break
                                                                                case 'con':
                                                                                    ability_type_string = '體質 +'+ability_item
                                                                                    break
                                                                                case 'int':
                                                                                    ability_type_string = '智力 +'+ability_item
                                                                                    break
                                                                                case 'wis':
                                                                                    ability_type_string = '感知 +'+ability_item
                                                                                    break
                                                                                case 'cha':
                                                                                    ability_type_string = '魅力 +'+ability_item
                                                                                    break
                                                                                default:
